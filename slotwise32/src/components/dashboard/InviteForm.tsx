    ...
    <div>
      ...
      <form onSubmit={invite} className="flex items-center gap-2">
        ...
        <select
          ...
          className="px-2 py-2 border border-zinc-700 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-white/20 bg-zinc-950"
        >
        ...
        <button
          type="submit"
          disabled={loading}
          className="flex items-center gap-1.5 px-3 py-2 bg-white hover:bg-zinc-100 disabled:opacity-60 text-white text-sm font-medium rounded-lg transition-colors shrink-0"
        >
          <UserPlus size={14} />
          {loading ? '...' : 'Invite'}
        </button>
