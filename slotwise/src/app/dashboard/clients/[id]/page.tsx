    ...
    <div className="p-8 max-w-4xl">
      ...
      <div className="flex items-start justify-between mb-6">
        <div className="flex items-center gap-3">
          <div className="w-12 h-12 rounded-xl bg-violet-100 flex items-center justify-center text-lg font-semibold text-violet-700">
      ...
      <div className="bg-white rounded-xl border border-gray-200">
        ...
        {client.booking_links && client.booking_links.length > 0 ? (
          ...
          <div className="px-5 py-10 text-center text-sm text-gray-400">
            ...
            <Link href={`/dashboard/links/new?client=${id}`} className="text-violet-600 hover:text-violet-700">
              Create one
            </Link>
          </div>
        )}
