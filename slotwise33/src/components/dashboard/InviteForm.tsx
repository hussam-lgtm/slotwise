    ...
    <div>
      ...
      <form onSubmit={invite} className="flex items-center gap-2">
        ...
        <select
          ...
          className="px-2 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-black/20 bg-white"
        >
        ...
        <button
          type="submit"
          disabled={loading}
          className="flex items-center gap-1.5 px-3 py-2 bg-black hover:bg-gray-800 disabled:opacity-60 text-gray-900 text-sm font-medium rounded-lg transition-colors shrink-0"
        >
          <UserPlus size={14} />
          {loading ? '...' : 'Invite'}
        </button>
