        ...
        <div className="bg-white rounded-xl border border-gray-200 p-5">
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className={`relative w-11 h-6 rounded-full transition-colors ${form.is_active ? 'bg-violet-600' : 'bg-gray-300'}`}
            >
              ...
              return (
                <div key={key} className="flex items-center gap-3">
                  <button
                    ...
                    className={`w-24 text-left text-sm py-1.5 px-2 rounded-md transition-colors font-medium ${enabled ? 'text-violet-700 bg-violet-50' : 'text-gray-400 hover:text-gray-600'}`}
                  >
                    {label.slice(0, 3)}
                  </button>
                  {enabled && slot ? (
